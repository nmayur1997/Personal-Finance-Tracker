...
def plot_transactions(df):
    ...
    print("DataFrame before setting index and resampling:")
    print(df)
    ...
    # Print the resampled dataframes to check the data
    print("Income DataFrame after resampling:")
    print(income_df)
    print("Expense DataFrame after resampling:")
    print(expense_df)
...
def main():
    CSV.initialize_csv()  # Ensure CSV is initialized before any operation
    while True:
